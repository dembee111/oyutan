      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li><i class="fa fa-home"></i>Fee Report</li>
          </ol>
        </div>
      </div>
         ...
         <div class="panel-heading">
           ...
           <table>
             <tr>
               ...
               <td>
                 <input type="text" name="from" id="from" class="form-control" placeholder="yyyy-mm-dd" value="{{ date('Y-m-d') }}"
                 required>
               </td>
               <td>
                 <input type="text" name="to" id="to" class="form-control" placeholder="yyyy-mm-dd" value="{{ date('Y-m-d') }}"
                 required>
               </td>
             </tr>
           </table>
